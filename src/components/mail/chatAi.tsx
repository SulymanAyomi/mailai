...
const ChatAI = ({ isCollapsed }: { isCollapsed: boolean }) => {
          ...
          <AnimatePresence mode="wait">
            {messages.map((message) => (
              <motion.div
                ...
                layout="position"
                className={cn(
                  "z-10 mt-2 max-w-[500px] break-words rounded-2xl bg-gray-200 dark:bg-gray-800",
                  {
        ...
        <div className="w-full">
          ...
          <form onSubmit={handleSubmit} className="flex w-full">
            <input
              ...
              value={input}
              className="relative h-9 max-w-full flex-grow rounded-full border border-gray-200 bg-white px-3 py-2 text-[15px] outline-none placeholder:text-[13px] placeholder:text-gray-400 focus-visible:ring-0 focus-visible:ring-blue-500/20 focus-visible:ring-offset-1 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-100 dark:placeholder-gray-400 dark:focus-visible:ring-blue-500/20 dark:focus-visible:ring-offset-1 dark:focus-visible:ring-offset-gray-700"
